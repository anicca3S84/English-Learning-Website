...
<body>
    ...
    <div class="container">
        <div class="test-header">
            ...
            <div class="score mt-3 text-center text-success font-weight-bold" id="score-area" style="font-size: 20px;">
            </div>


            <div class="question-container">
                <div class="navigation">
                    <button type="button" onclick="loadQuestion(currentIndex - 1)" id="prevButton">&lt;
                        Previous</button>
                ...
                <div class="options">
                    <label class="option"><input type="radio" name="answer" value="A" id="optionA"><span
                            id="textA"></span></label>
                    <label class="option"><input type="radio" name="answer" value="B" id="optionB"><span
                            id="textB"></span></label>
                    <label class="option"><input type="radio" name="answer" value="C" id="optionC"><span
                            id="textC"></span></label>
                </div>
    ...
    <script>
        ...
        function renderQuestion() {
            ...
            document.getElementById('nextButton').style.visibility = currentIndex === totalQuestions - 1 ? 'hidden' :
                'visible';
        }
