...
<!-- Task Preparation -->
<div class="accordion" id="accordionPreparation">
    <div class="card">
        <div class="card-header" id="headingPreparation">
            <a href="#" class="listening-description" data-toggle="collapse"
                data-target="#collapsePreparation" aria-expanded="false" aria-controls="collapsePreparation"
                style="color: #23085A;">
                Preparation
                <span class="arrow-icon">▼</span>
            </a>
        ...
        <div id="collapsePreparation" class="collapse" aria-labelledby="headingPreparation"
            data-parent="#accordionPreparation">
            <div class="card-body">
